...
<html lang="en">
    ...
    <body>
        ...
        <fieldset>
            ...
            <button onclick="imagefun11()" value="Change Image4"><img id="loveimage4" src="../images/love.png" alt="like"></button>
            <button onclick="imagefun12()" value="Change Icon"><img id="timeimage4" src="../images/repost.png" alt="like"></button>
        </fieldset>
